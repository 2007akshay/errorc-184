            ...
            <View style={styles.container}>
                ...
                <View style={styles.framesContainer}>
                    <View style={styles.catContainer}>
                        <TouchableOpacity style={this.state.selected=="regular"?styles.catBoxSelected:styles.catBox} onPress={()=>this.setState({selected:`regular`})}>
                            <Text>Regular</Text>
                             </TouchableOpacity>
                             <TouchableOpacity style={this.state.selected=="wayfarer"?styles.catBoxSelected:styles.catBox} onPress={()=>this.setState({selected:`wayfarer`})}>
                            <Text>wayfarer</Text>
                             </TouchableOpacity>
                             <TouchableOpacity style={this.state.selected=="rimless"?styles.catBoxSelected:styles.catBox} onPress={()=>this.setState({selected:`rimless`})}>
                            <Text>Rimless</Text>
                             </TouchableOpacity>
                             <TouchableOpacity style={this.state.selected=="round"?styles.catBoxSelected:styles.catBox} onPress={()=>this.setState({selected:`round`})}>
                            <Text>Round</Text>
                             </TouchableOpacity>
                             <TouchableOpacity style={this.state.selected=="aviater"?styles.catBoxSelected:styles.catBox} onPress={()=>this.setState({selected:`aviater`})}>
                            <Text>Aviater</Text>
                             </TouchableOpacity>
                    </View>
